...
impl From<crate::domain::MrpError> for cuba_shared::AppError {
    fn from(err: crate::domain::MrpError) -> Self {
        match err {
            crate::domain::MrpError::MrpRunNotFound => {
            ...
            crate::domain::MrpError::MrpSuggestionNotFound => {
                cuba_shared::AppError::Business {
            ...
            crate::domain::MrpError::ProductVariantNotFound => {
                cuba_shared::AppError::Business {
            ...
            crate::domain::MrpError::ProductVariantRequired => {
                cuba_shared::AppError::Business {
            ...
            | crate::domain::MrpError::RequiredFieldEmpty(_) => {
                cuba_shared::AppError::Business {
            ...
            crate::domain::MrpError::MrpRunFailed => {
                cuba_shared::AppError::Business {
                    code: "MRP_RUN_FAILED",
                    message: err.to_string(),
                }
