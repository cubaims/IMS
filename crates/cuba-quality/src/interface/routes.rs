use crate::interface::handlers::{
    ...
    create_inspection_lot_handler, freeze_batch_handler,
    get_batch_quality_status_handler, get_inspection_lot_handler,
    get_quality_notification_handler, list_batch_quality_history_handler,
    list_inspection_lots_handler, list_inspection_results_handler,
    list_quality_notifications_handler, make_inspection_decision_handler,
    scrap_batch_handler, unfreeze_batch_handler,
};
use axum::{
    routing::{get, post},
    Router,
...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            ...
            get(get_inspection_lot_handler),
        )
        // 检验结果
        .route(
        ...
        .route(
            "/notifications",
            get(list_quality_notifications_handler),
        )
        .route(
